...
nav {
  ...
  padding: 7px;
  border-radius: 10px;
  box-shadow: 1px 8px 20px #320000 inset, 0px 0px 8px -6px #FFFFFF;
  position: fixed;
  top: 80px;
  left: 50%;
...
nav a {
  ...
  box-shadow: 0px 0px 7px #000000 inset, 0px 6px 8px -3px #000000;
  display: flex;
...
.card {
  ...
  padding: 5px;
  text-align: center;
  box-shadow: 0 0px 3px 1px rgba(197, 0, 0, 1);
  overflow: hidden;
}
...
@media (max-width: 768px) {
  ...
  nav { flex-wrap: wrap; width: 95%; gap: 5px; }
...
@keyframes brilloSuave { 0% { text-shadow: 0 0 5px var(--color-secundario); } 50% { text-shadow: 0 0 20px var(--color-secundario), 0 0 30px var(--color-principal); } 100% { text-shadow: 0 0 5px var(--color-secundario); } }
